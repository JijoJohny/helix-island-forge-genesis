	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'pulse-soft': {
					'0%, 100%': { boxShadow: 'var(--shadow-neu-soft)' },
					'50%': { boxShadow: 'var(--shadow-neu-floating)' }
				},
				'glow-subtle': {
					'0%, 100%': { boxShadow: 'var(--shadow-neu-raised)' },
					'50%': { boxShadow: 'var(--shadow-neu-raised), var(--glow-mystic)' }
				}
			},
			animation: {
